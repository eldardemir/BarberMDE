                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            <button
                                class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-purple-200 transition">
                                <img class="h-8 w-8 rounded-full shadow-2xl border-2 object-cover"
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="/edit-profile">
                                {{ __('Profile') }}
                            </x-jet-dropdown-link>
