      ...
      <div class="flex flex-wrap -mx-4">
         <div class="w-full px-4">
            <div class="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
               ...
               <a class="text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-5xl"
                        href="">O<span
                            class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">ur services</span>
                    </a>
               <p class="text-base text-body-color">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem nostrum sapiente deserunt quidem dicta dolores!
               </p>
            </div>
         </div>
      </div>
