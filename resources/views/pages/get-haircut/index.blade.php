                ...
                <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                    <div class="max-w-[570px] lg:mb-0">
                        <div class="w-full flex items-center justify-between mb-4">
                            <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-7xl"
                                href="">
                                Get h<span
                                    class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">aircut</span>
                            </a>
                        </div>
                        ...
                        <form>
                            <div class="mb-6">
                                <div class="my-3 flex justify-center">
                                    <div class="w-full shadow-2xl rounded-3xl">
                                        <div class="md:p-8 p-5 dark:bg-gray-800 bg-gray-300 rounded-3xl">
                                            <div class="px-4 flex items-center justify-between">
                                                <span tabindex="0"
                                                    class="focus:outline-none text-base font-bold text-gray-800 text-xl">April
                                                    2022</span>
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <a role="link" tabindex="0"
                                                                        class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 focus:bg-gray-500 hover:bg-red-300  duration-200  text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-red-500 rounded-full">9</a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div
