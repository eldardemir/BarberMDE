    ...
    <section>
       <div class="pt-6">
             ...
             <div class="w-full px-4">
                <div class="text-center mx-auto mb-[60px] max-w-[510px]">
                   <h2
                      ...
                      "
                      >
                      <span class="text-5xl">Our Awesome Barbers</span>
                   </h2>
          ...
          <div class="flex flex-wrap justify-center -mx-4">
             <div class="w-full md:w-1/2 xl:w-1/4 px-4 hover:scale-105 duration-300">
                   ...
                   <div class="relative rounded-lg overflow-hidden">
                      ...
                      <div class="absolute w-full bottom-5 left-0 text-center">
                         <div
                            ...
                            "
                            >
                            <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500 font-bold text-2xl">
                               Coriss Ambady
                            </span>
                            <p class="text-sm text-body-color">CEO of BarberMDE</p>
                            <div>
                   ...
                   <div class="relative rounded-lg overflow-hidden">
                      ...
                      <div class="absolute w-full bottom-5 left-0 text-center">
                         <div
                            ...
                            <p class="text-sm text-body-color">Some barber title</p>
                            <div>
                               <span class="absolute left-0 bottom-0">
                                  <svg
                                     width="61"
