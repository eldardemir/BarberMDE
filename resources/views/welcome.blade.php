    ...
    <div class="h-full">
        ...
        <div class="container pt-24 md:pt-12 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                ...
                <form class="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('login') }}">
                    @csrf

                    <div>
                        <label>Email</label>
                        <input id="email" class="shadow my-2 appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out" placeholder="someone@location.com"  type="email" name="email" :value="old('email')" required autofocus />
                    </div>

                    <div class="mt-4">
                        <label>Password</label>
                        <input id="password" class="shadow my-2 appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out"  type="password" placeholder="Shh..." name="password" required autocomplete="current-password" />
                    </div>
